const baseUrl = process.env.SMOKE_BASE_URL || 'http://127.0.0.1:4820';
...
const adminCookie = await login('admin@smart-city-operations.local', 'admin123');
const managerCookie = await login('manager@smart-city-operations.local', 'manager123');
const analystCookie = await login('analyst@smart-city-operations.local', 'analyst123');
