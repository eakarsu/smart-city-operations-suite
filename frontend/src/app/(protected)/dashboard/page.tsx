...
export default function DashboardPage() {
  return (
    <UnifiedShell
      ...
      subtitle="One merged smart city operations view for Cases, Incidents, Units, Schedules, Evidence, documents, audit, and AI."
    >
      ...
      <div className="grid columns-2">
        <div className="card stack">
          ...
          <div className="muted">
            This suite removes project-based navigation and groups shared smart city operations jobs into one surface. Cases, Incidents, Units, Schedules, Evidence, Permits, documents, audit, and AI are presented as platform features.</div>
