...
const entitySeeds = [
  ...
  ["traffic-signal-optimization","Traffic Signal Optimization Records","Traffic Signal Optimization operating queue","Open","Traffic Signal Optimization follow-up list","Smart City Traffic Signal","$0"],
  ["intersection-delay-review","Intersection Delay Review Records","Intersection Delay Review operating queue","Review","Intersection Delay Review follow-up list","Smart City Traffic Signal","$0"],
  ["mobility-impact-plan","Mobility Impact Plan Records","Mobility Impact Plan operating queue","Review","Mobility Impact Plan follow-up list","Smart City Traffic Signal","$0"],
  ["zoning-simulation","Zoning Simulation Records","Zoning Simulation operating queue","Open","Zoning Simulation follow-up list","Urban Planning Zoning Simulator","$0"],
  ["urban-plan-scenarios","Urban Plan Scenarios Records","Urban Plan Scenarios operating queue","Review","Urban Plan Scenarios follow-up list","Urban Planning Zoning Simulator","$0"],
  ["planning-impact-review","Planning Impact Review Records","Planning Impact Review operating queue","Review","Planning Impact Review follow-up list","Urban Planning Zoning Simulator","$0"],
