...
const featureSeeds = [
  ...
  ["traffic-signal-optimization","Traffic Signal Optimization","Traffic Signal Optimization review queue","Smart City Traffic Signal","Review source context and assign owner"],
  ["intersection-delay-review","Intersection Delay Review","Intersection Delay Review review queue","Smart City Traffic Signal","Confirm next action and update evidence"],
  ["mobility-impact-plan","Mobility Impact Plan","Mobility Impact Plan review queue","Smart City Traffic Signal","Confirm next action and update evidence"],
  ["zoning-simulation","Zoning Simulation","Zoning Simulation review queue","Urban Planning Zoning Simulator","Review source context and assign owner"],
  ["urban-plan-scenarios","Urban Plan Scenarios","Urban Plan Scenarios review queue","Urban Planning Zoning Simulator","Confirm next action and update evidence"],
  ["planning-impact-review","Planning Impact Review","Planning Impact Review review queue","Urban Planning Zoning Simulator","Confirm next action and update evidence"],
