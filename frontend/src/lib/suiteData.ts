...
export const sourceSystems = [
  { name: 'AISmartCityOperationsAssistant', ownership: 'Cases source capabilities and workflows', coverage: ['Cases', 'Incidents', 'Units'] },
  { name: 'AISmartCityOperationsOperations', ownership: 'Incidents source capabilities and workflows', coverage: ['Schedules', 'Evidence', 'Permits'] },
  { name: 'AISmartCityOperationsAnalytics', ownership: 'Units source capabilities and workflows', coverage: ['Approvals', 'Resources', 'Compliance'] },
  { name: 'AISmartCityOperationsWorkflow', ownership: 'Schedules source capabilities and workflows', coverage: ['Alerts', 'Analytics', 'Reports'] },
];
