...
PORT="${PORT:-4820}"
DB_NAME="${PGDATABASE:-smart_city_operations_suite}"
DB_HOST="${PGHOST:-127.0.0.1}"

echo "======================================="
echo "      Smart City Operations Suite"
echo "======================================="
echo
...
echo "Starting smart city operations suite frontend on http://localhost:$PORT"
echo "Login: admin@smart-city-operations.local / admin123"
